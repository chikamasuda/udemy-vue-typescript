...
onMounted(async () => {
  ...
  try {
    data.value = await axios.get('https://vue3-sample-a44bb-default-rtdb.europe-west1.firebasedatabase.app/surveys.json')
  } catch (e) {
...
const onSubmit = (e: Event) => {
  // fetch('https://vue3-sample-a44bb-default-rtdb.europe-west1.firebasedatabase.app/surveys.json', {
  //   method: 'POST',
  //   headers: {
  ...
  // })
  axios.post('https://vue3-sample-a44bb-default-rtdb.europe-west1.firebasedatabase.app/surveys.json', {
    name: userName.value,
